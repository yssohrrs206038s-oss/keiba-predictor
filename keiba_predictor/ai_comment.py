...
def generate_comments(
    ...
    system_prompt = (
        ...
        "【重要】提供されたデータのみを使用すること。オッズ、EVスコア、配当など提供されていない数値を捏造・推測して書いてはいけません。"
    )
    ...
    prompt = (
        ...
        f"- 【禁止】オッズの具体的な数値（例:24.2倍）、EVスコア（例:EV14.07）、配当金額は絶対に書かないこと。提供データに含まれていない数値を捏造しないこと\n"
        f"- オッズの代わりに「○番人気」「人気薄」「上位人気」等の表現を使う\n\n"
